   ...
   <!-- 控制内容 -->
    ...
    <div class="row">
       <div class="tab-pane" id="all">
    	...
    	<s:iterator value="products" var="product" status="stu">
    		<tr align="center">
    			<td width="60"><s:property value="#stu.count+7*(pager.curPage-1)"/></td>
    			<td width="120"><img src="<s:property value="#product.path"/>" width="100" height="100"></img></td>
    			<td width="120"><s:property value="#product.name"/></td>
    			<td width="120"><s:property value="#product.price"/></td>
    			<td width="120"><s:property value="#product.type"/></td>
    			<td width="120">
    				<s:a href="showProduct.action?pid=%{#product.id}">查看</s:a>
    				<s:a href="updateProduct.action?pid=%{#product.id}">编辑</s:a>
