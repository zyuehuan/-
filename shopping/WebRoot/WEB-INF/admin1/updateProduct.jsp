  ...
  <!--导航栏部分-->
   ...
   <!-- 控制内容 -->
            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <form action="updatedProduct" method="post" enctype="multipart/form-data">       <!-- 表单输入 -->
                        ...
                        <div  class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 col-md-6">
                                    <textarea type="text" name="description" class="form-control" id="productDescribe">${product.description}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="keyWord" class="col-sm-2 col-md-2 control-label">关键词</label>
                                <div class="col-sm-6 col-md-6">
                                    <textarea type="text" class="form-control" name="keyword" id="keyword">${product.keyword}</textarea>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="productPrice" class="col-sm-2 col-md-2 control-label">商品价格</label>
                                <div class="col-sm-6 col-md-6">
                                    <input type="text" class="form-control" name="price" id="productPrice" placeholder="399" value="${product.price}"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="productCount" class="col-sm-2 col-md-2 control-label">商品数量</label>
                                <div class="col-sm-6 col-md-6">
                                    <input type="text" class="form-control" name="counts" id="productCount" placeholder="100" value="${product.counts}"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-6">
                                    <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="addProduct()">编辑商品</button>
                                </div>
                            </div>
                        </div>
                        <br/>
